//Recreated by ThaiQ
//Created by Brayden Cloud (Youtube Channel)
using System.Collections;
using System.Collections.Generic;
using UnityEngine;

public class NewPacman : MonoBehaviour {
    ...
    // Used to Number/Find all the waypoints in the map
	void Start () {
